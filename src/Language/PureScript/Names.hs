...
instance FromJSON InternalIdentData where
  parseJSON = A.genericParseJSON defaultOptions {sumEncoding = ObjectWithSingleField}

instance ToJSON InternalIdentData where
...
instance A.ToJSONKey (ProperName a)

instance A.FromJSONKey (ProperName a)
...
instance A.FromJSON QualifiedBy

instance A.ToJSON QualifiedBy

instance A.FromJSONKey QualifiedBy

instance A.ToJSONKey QualifiedBy
...
instance (FromJSON a, FromJSONKey a) => FromJSONKey (Qualified a)
