...
import Language.PureScript.Lsp.Handlers.Definition (findDeclRefAtPos, fromPrim, getExprsAtPos, getImportRefNameType, getTypeRowsAndColumns, getTypedValuesAtPos, getTypesAtPos, isNullSourceTypeSpan, isPrimImport, smallestExpr, spanToRange)
...
--                   sourcePosColumn = 1
--                 },
--             spanEnd = SourcePos {sourcePosLine = 19, sourcePosColumn = 24}
--           },
--         []
--       )
--       (SourceSpan {spanStart = SourcePos {sourcePosLine = 18, sourcePosColumn = 31}, spanEnd = SourcePos {sourcePosLine = 18, sourcePosColumn = 49}}, [])
--       (ChainId (,SourcePos {sourcePosLine = 18, sourcePosColumn = 1}))
--       0
--       (Right (Ident "monadEffectEffect"))
--       []
--       (Qualified (ByModuleName (ModuleName "Effect.Class")) (ProperName {runProperName = "MonadEffect"}))
--       [TypeConstructor (SourceSpan {spanStart = SourcePos {sourcePosLine = 18, sourcePosColumn = 43}, spanEnd = SourcePos {sourcePosLine = 18, sourcePosColumn = 49}}, []) (Qualified (ByModuleName (ModuleName "Effect")) (ProperName {runProperName = "Effect"}))]
--       (ExplicitInstance [ValueDeclaration (ValueDeclarationData {valdeclSourceAnn = (SourceSpan {spanStart = SourcePos {sourcePosLine = 19, sourcePosColumn = 3}, spanEnd = SourcePos {sourcePosLine = 19, sourcePosColumn = 24}}, []), valdeclIdent = Ident "liftEffect", valdeclName = Public, valdeclBinders = [], valdeclExpression = [GuardedExpr [] (PositionedValue (SourceSpan {spanStart = SourcePos {sourcePosLine = 19, sourcePosColumn = 16}, spanEnd = SourcePos {sourcePosLine = 19, sourcePosColumn = 24}}) [] (Var (SourceSpan {spanStart = SourcePos {sourcePosLine = 19, sourcePosColumn = 16}, spanEnd = SourcePos {sourcePosLine = 19, sourcePosColumn = 24}}) (Qualified (ByModuleName (ModuleName "Control.Category")) (Ident "identity"))))]})]),
--     ValueDeclaration
--       ( ValueDeclarationData
--           { valdeclSourceAnn =
--               ( SourceSpan
--                   { spanStart = SourcePos {sourcePosLine = 18, sourcePosColumn = 1},
--                     spanEnd = SourcePos {sourcePosLine = 19, sourcePosColumn = 24}
--                   },
--                 []
--               ),
--             valdeclIdent = Ident "monadEffectEffect",
--             valdeclName = Private,
--             valdeclBinders = [],
--             valdeclExpression =
--               [ GuardedExpr
