...
newtype HandlerM a = HandlerM (ReaderT LspEnvironment (LspT ServerConfig IO) a)
...
unHandlerM :: HandlerM a -> ReaderT LspEnvironment (LspT ServerConfig IO) a
unHandlerM (HandlerM a) = a
